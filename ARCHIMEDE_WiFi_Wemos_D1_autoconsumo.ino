...
//char auth[] = "f969652052ac3644e7a53afc099d3f40";  
 char auth[]= "9d3f40f969652052ac3644e7a53afc09";                   // Archimede contawatt:     BUONO               
//
// inserire i dati del modem:
const char* ssid = "TIM-19093013";                             // sostituire con i dati del proprio router/modem:
const char* password = "DWgEViTPcoGvIgpBEOvX1wh1";                 // sostituire con la password del proprio router/modem:
//
int pinV1valore = 0;
int pinV2valore = 0;
int pinV3valore = 0;
