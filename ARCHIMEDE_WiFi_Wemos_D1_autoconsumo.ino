// ARCHIMEDE WiFi Wemos D1 autoconsumo Ver. 0.0 del 27/12/2017
// Video YouTube: IN PREPARAZIONE
/*************************************************************
...
char auth[] = "f969652052ac3644e7a53afc099d3f40";                 
//
// inserire i dati del modem:
const char* ssid = "Telecom-66339564";                             // sostituire con i dati del proprio router/modem:
const char* password = "YHcGYNuiCpV1ZNB9Fjwu8G4q";                 // sostituire con la password del proprio router/modem:
//
int pinV1valore = 0;
int pinV2valore = 0;
int pinV3valore = 0;
