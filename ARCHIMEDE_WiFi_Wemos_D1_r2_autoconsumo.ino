...
char auth[] = "6965203afc09952ac3644e7a5d3f40f9";                  // Archimede contawatt:     
//
// inserire i dati del modem:
const char* ssid = "EOLO - FRITZ!Box HC";                      // sostituire con i dati del proprio router/modem:
const char* password = "13462315761458132670";                 // sostituire con la password del proprio router/modem:
//
int pinV1valore = 0;
int pinV2valore = 0;
int pinV3valore = 0;
...
void loop()
{
  ...
  if (tempo_adesso > timer_rele_vecchio + 6000)     // sono passati 10 secondi, solo per prova, i motori hanno uno spunto di consumo:
  {
