  ...
  if (corrente_millis_minuti > vecchio_millis_minuti + 300000)   // significa che sono passati 5 minuti (60.000 x 5 = 300000):
  {
    ...
    { 
      ...
      {  
        ...
        //
        file = SD.open("produz_24h.txt", FILE_WRITE); //File in scrittura, ATTEBNZIONE: non mettere nomi troppo lunghi:  
        if (file) //Se il file è stato aperto correttamente:
        {    
          contawatt_24hp = impulsi_24hp*1000/impulsi_kwh; 
        ...
        if (file) //Se il file è stato aperto correttamente:
        {    
          contawatt_24hc = impulsi_24hc*1000/impulsi_kwh; 
